    ...
    <main className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      <div className="mx-auto max-w-6xl px-4 py-8">
        ...
        <header className="mb-8">
          <Link
            href={routes.home}
            className="inline-flex items-center gap-2 text-sm text-gray-600 hover:text-gray-900 dark:text-zinc-400 dark:hover:text-zinc-200 mb-4"
          >
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <article className="flex-1 min-w-0 space-y-6">
            ...
            <DocSection id="overview" title="Overview" icon={<OverviewIcon />}>
              ...
              <div className="grid gap-4 sm:grid-cols-3 mt-4">
                <div className="bg-gray-50 rounded-lg p-4 dark:bg-zinc-800">
                  <div className="text-2xl font-bold text-gray-900 dark:text-zinc-50">100%</div>
                  <div className="text-sm text-gray-600 dark:text-zinc-400">Free to use</div>
                </div>
                <div className="bg-gray-50 rounded-lg p-4 dark:bg-zinc-800">
                  <div className="text-2xl font-bold text-gray-900 dark:text-zinc-50">Nonpartisan</div>
                  <div className="text-sm text-gray-600 dark:text-zinc-400">Fact-based info</div>
                </div>
                <div className="bg-gray-50 rounded-lg p-4 dark:bg-zinc-800">
                  <div className="text-2xl font-bold text-gray-900 dark:text-zinc-50">Open</div>
                  <div className="text-sm text-gray-600 dark:text-zinc-400">Source available</div>
                </div>
              </div>
            </DocSection>
            ...
            <DocSection id="data-sources" title="Data Sources" icon={<DataSourceIcon />}>
              ...
              <div className="bg-gray-50 rounded-lg p-4 mt-4 dark:bg-zinc-800">
                <div className="flex items-start gap-3">
                  <div className="p-2 bg-white rounded-lg shadow-sm dark:bg-zinc-700">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="font-semibold text-gray-900 dark:text-zinc-50">Congress.gov API</h3>
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-1 text-sm text-blue-600 hover:underline mt-2 dark:text-blue-400"
                    >
              ...
              <h3 className="font-semibold text-gray-900 mt-6 mb-3 dark:text-zinc-50">What we track:</h3>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-gray-200 dark:border-zinc-700">
                      <th className="text-left py-3 pr-4 font-semibold text-gray-900 dark:text-zinc-50">Data Type</th>
                      <th className="text-left py-3 pr-4 font-semibold text-gray-900 dark:text-zinc-50">Update Frequency</th>
                      <th className="text-left py-3 font-semibold text-gray-900 dark:text-zinc-50">Notes</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-100 dark:divide-zinc-800">
                    <tr>
                      ...
                      <td className="py-3 text-gray-500 dark:text-zinc-500">9am–9pm ET on weekdays</td>
                    </tr>
                    <tr>
                      <td className="py-3 pr-4 font-medium">Bills</td>
                      <td className="py-3 pr-4">Daily</td>
                      <td className="py-3 text-gray-500 dark:text-zinc-500">Every morning</td>
                    </tr>
                    <tr>
                      <td className="py-3 pr-4 font-medium">Members</td>
                      <td className="py-3 pr-4">Weekly</td>
                      <td className="py-3 text-gray-500 dark:text-zinc-500">Sunday sync</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <DocSection id="ai-content" title="AI-Generated Content" icon={<AIIcon />}>
              ...
              <h3 className="font-semibold text-gray-900 mt-6 mb-3 dark:text-zinc-50">What&apos;s AI-generated:</h3>
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
              ...
              <p className="text-sm text-gray-500 mt-4 dark:text-zinc-500">
            ...
            <DocSection id="technology" title="Technology" icon={<TechIcon />}>
              ...
              <div className="grid gap-4 sm:grid-cols-2 mt-4">
                <div className="bg-gray-50 rounded-lg p-4 dark:bg-zinc-800">
                  <h4 className="font-semibold text-gray-900 mb-1 dark:text-zinc-50">Fast & Responsive</h4>
                  <p className="text-sm text-gray-600 dark:text-zinc-400">
                    Built for speed with server-side rendering and optimized data loading
                  </p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4 dark:bg-zinc-800">
                  <h4 className="font-semibold text-gray-900 mb-1 dark:text-zinc-50">Works Everywhere</h4>
                  <p className="text-sm text-gray-600 dark:text-zinc-400">
                    Designed to work on phones, tablets, and desktops
                  </p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4 dark:bg-zinc-800">
                  <h4 className="font-semibold text-gray-900 mb-1 dark:text-zinc-50">Secure</h4>
                  <p className="text-sm text-gray-600 dark:text-zinc-400">
                    All connections encrypted, no tracking or data collection
                  </p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4 dark:bg-zinc-800">
                  <h4 className="font-semibold text-gray-900 mb-1 dark:text-zinc-50">Accessible</h4>
                  <p className="text-sm text-gray-600 dark:text-zinc-400">
            ...
            <DocSection id="open-source" title="Open Source" icon={<OpenSourceIcon />}>
              ...
              <div className="bg-gray-900 rounded-lg p-6 mt-4 text-white dark:bg-zinc-800">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">Explore the code, report issues, or contribute</p>
                  </div>
                </div>
                <a
              ...
              <h3 className="font-semibold text-gray-900 mt-6 mb-3 dark:text-zinc-50">Ways to Contribute</h3>
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
